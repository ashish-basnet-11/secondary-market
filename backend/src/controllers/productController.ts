...
export const getAllProducts = async (req: Request, res: Response) => {
    try {
        ...
        // Define the object using the official Prisma type
    ...
    try {
        ...
        const updated = await prisma.product.update({
            ...
            data: {
                ...
                // Handle originalPrice potentially being null
...
export const getMyProducts = async (req: Request, res: Response) => {
  try {
    const sellerId = res.locals.userId; // Provided by your authenticate middleware
